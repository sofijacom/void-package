...
export SHA256=$(curl -L https://github.com/RealityRipple/Pale-Moon/releases/download/${LATEST_VERSION}/archive/refs/tags/${LATEST_VERSION}.tar.gz.sha256 | cut -d ' ' -f1 )
