...
export SHA256=$(curl -L https://github.com/shiftkey/desktop/releases/latest/download/${VERSION}/release-3.4.13-linux1/GitHubDesktop-linux-amd64-${VERSION}-linux1.deb.sha256 | cut -d ' ' -f1 )
