...
export SHA256=$(curl -L https://github.com/RealityRipple/Pale-Moon/releases/download/${VERSION}_Release/archive/refs/tags/${VERSION}_Release.tar.gz.sha256 | cut -d ' ' -f1 )
