...
export SHA256=$(curl -L https://github.com/NDViet/microsoft-edge-stable/releases/download/147.0.3912.72-1/microsoft-edge-stable_147.0.3912.72-1_amd64.deb.sha256 | cut -d ' ' -f1 )
