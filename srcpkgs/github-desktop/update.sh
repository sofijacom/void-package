...
export SHA256=$(curl -L https://github.com/shiftkey/desktop/releases/latest/download/${VERSION}/archive/refs/tags/GitHubDesktop-linux-amd64-${VERSION}-linux1.deb.sha256 | cut -d ' ' -f1 )
