...
export SHA256=$(curl -L https://github.com/shiftkey/desktop/releases/latest/download/${VERSION}/archive/refs/tags/release-${VERSION}-linux1.tar.gz.sha256 | cut -d ' ' -f1 )
